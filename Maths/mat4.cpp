...
namespace sparky {
	namespace maths {
		...
		mat4 mat4::prespictive(float fov, float aspectRation, float near, float far) {
			mat4 result(1.0f);
			float q = 1.0f / tan(rnd(0.5f * fov));
		...
		mat4 mat4::rotation(float angle, const vec3 axis) {
			...
			result.elements[2 + 0 * 4] = x*z* omc - y*c;
